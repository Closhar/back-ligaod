...
<template>
    <div class="text-sm text-red-300 font-bold px-2 align-baseline" v-show="showDel">
        <span>удалить изображение</span>
    </div>
    <div class="hover:opacity-50 cursor-pointer" @click.prevent="delInItem" :style="divSize" @mouseover="showDel = true"
         @mouseleave="showDel = false">

        <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 26 26">
            <g fill="none">
                <defs>
                    <mask id="pepiconsPopTrashCircleFilled0">
                        <path :fill="color" d="M0 0h26v26H0z"/>
                        <g fill="#000">
                ...
                <circle cx="13" cy="13" r="13" fill="#fb0000" mask="url(#pepiconsPopTrashCircleFilled0)"/>
            </g>
        </svg>
    </div>
</template>
