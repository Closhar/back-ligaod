<!DOCTYPE html>
<html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Восстановление пароля</title></head>
...
<div style="max-width:560px;margin:auto;background:#fff;border-radius:16px;padding:32px;text-align:center">
  ...
  <p style="line-height:1.5">Для смены пароля на сайте «{{ $siteName }}» введите этот код:</p>
