...
class ApiEventController extends Controller
{
    ...
    public function index(Request $request): array
    {
        ...
        $query = Event::query()
            ->select('id', 'title', 'date_from', 'date_to', 'result', 'result_dop', 'image', 'competition_id', 'arena_id', 'club1_id', 'club2_id', 'region_id', 'is_active', 'event_name', 'series_id', 'stream_id', 'series_count', 'about')
            ->with([
                'streams',
    ...
    public function show(Event $event, $id): array
    {
        ...
        if ($event->series_id) {
            $seriesEvents = Event::where('series_id', $event->series_id)
                ->select(['id', 'date_from', 'club1_id', 'club2_id', 'result', 'result_dop', 'is_active'])
                ->with([
                    'club1' => function ($query) {
