...
- Каждое событие начинайте с новой строки
- Перед каждым событием ставьте соответствующий эмодзи
- Название события выделяйте жирным шрифтом
- Результат и место проведения размещайте на отдельных строках
- Между событиями оставляйте пустую строку
- Используйте маркеры для списков
- Добавляйте хэштеги в конце текста
