...
Route::group(['prefix' => '/v1'], function () {
    ...
    Route::get('/contacts', [ContactController::class, 'publicData'])->name('api.contacts.public');
    Route::post('/contact-messages', [ContactController::class, 'storeMessage'])->name('api.contact-messages.store');
    ...
    Route::prefix('rating')->group(function () {
        ...
        Route::get('/competitions', [RatingController::class, 'getCompetitions']);
    });
});
...
Route::put('contacts/admin', [ContactController::class, 'update']);
Route::patch('contact-messages/{contactMessage}', [ContactController::class, 'updateMessage']);
Route::delete('contact-messages/{contactMessage}', [ContactController::class, 'destroyMessage']);
...
Route::prefix('people/{person}/statistics')->group(function () {
    ...
    Route::get('/season-title/{seasonTitle}', [PlayerStatisticsController::class, 'getPersonStatsBySeasonTitle']);
    ...
    Route::get('/season/{season}/competitions', [PlayerStatisticsController::class, 'getPersonCompetitionsBySeason']);
