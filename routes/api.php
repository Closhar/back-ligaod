...
Route::group(['prefix' => '/v1', 'namespace' => 'Api'], function () {
    ...
    Route::get('/clubs', [ApiClubController::class, 'index'])->name('clubs.index');
    Route::get('/clubs/{id}', [ApiClubController::class, 'show'])->name('clubs.show');
    ...
    Route::get('/competitions', [ApiCompetitionController::class, 'index'])->name('competitions.index');
    Route::get('/competitions/{id}', [ApiCompetitionController::class, 'show'])->name('competitions.show');
    Route::get('/events', [ApiEventController::class, 'index'])->name('events.index');
    Route::get('/events/{id}', [ApiEventController::class, 'show'])->name('events.show');
