...
try {
    $personId = 40;
    $seasonId = 1; // 2025 - сезон, к которому привязаны события игрока

    echo "=== ТЕСТИРОВАНИЕ СТАТИСТИКИ ПО СЕЗОНУ ===\n";
    ...
    foreach ($events as $event) {
        ...
        foreach ($event->actions as $action) {
            ...
            echo "  Действие: {$actionName} (группа: {$actionType->group})\n";
